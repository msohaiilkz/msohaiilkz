...
I'm a **Frontend-focused developer** evolving into a Full-Stack engineer. I craft **sleek, high-performing, and intuitive user experiences** using modern web technologies. 

My philosophy: **"Code with logic. Design with emotion. Deliver with impact."**

Currently mastering:
- 🚀 **Next.js** (SSR, ISR, App Router, Edge Deployment)
...
| **Firebase & Cloud** | Authentication, Firestore, Realtime Database, Storage, Cloud Functions, Hosting |
| **UX/Animation Expert** | GSAP, Framer Motion, Lenis SmoothScroll, Custom CSS Animations |
| **Type-Safe Development** | Advanced TypeScript patterns for scalable applications |
| **Performance Focused** | Core Web Vitals optimization, lazy loading, code splitting |
...
- 🎯 **Remote opportunities** with modern tech stacks
- 💼 **Freelance projects** for innovative clients
- 🤝 **Collaborations** on open-source or custom solutions
- 📱 **Automation systems** and full-stack applications

**Let's create experiences that are:**
- ⚡ Fast & performant
- 🎨 Visually stunning
- ✅ Functionally impeccable
